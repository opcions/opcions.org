  ...
  CKEDITOR.plugins.add('simplebox', {
    ...
    init: function (editor) {
      ...
      editor.widgets.add('simplebox', {
        ...
        allowedContent: 'aside(!simplebox,align-left,align-right,align-center){width};' +
        'div(!simplebox-content); h3(!simplebox-title)',

        // Minimum HTML which is required by this widget to work.
        requiredContent: 'aside(simplebox)',
        ...
        editables: {
          ...
          content: {
            ...
            allowedContent: 'p strong em ul ol li;a[href];img[data-*,src,alt,width,height]'
          }
        },
        ...
        upcast: function (element) {
          ...
          return element.name == 'aside' && element.hasClass('simplebox');
        },
